...
(                                                                                                                                                         \
neat_static_assertx(!neat_is_array_of(NEAT_ARG1(__VA_ARGS__), Neat_String_View), "strv_arr accpets variadic arguments of strings, not String_View[], call strv_arr_from_carr instead"), \
(Neat_String_View_Array) {                                                                                                                                \
